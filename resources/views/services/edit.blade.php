<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="text-xl font-bold text-gray-900">Editar Servicio: {{ $service->name }}</h2>
                <p class="text-sm text-gray-600">Modifica la información del servicio</p>
            </div>
        </div>
    </x-slot>
                    ...
                    <div class="p-6 md:p-8 space-y-6">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600">Modifica los detalles del servicio.</p>
                            </div>
                        </div>
                        ...
                        <div class="space-y-6 border-t-2 border-gray-100 pt-6">
                            ...
                            <div>
                                ...
                                <textarea id="description" name="description" rows="4" class="mt-1 block w-full border-2 border-gray-300 text-gray-900 rounded-xl shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-all duration-150" placeholder="Describe el servicio...">{{ old('description', $service->description) }}</textarea>
